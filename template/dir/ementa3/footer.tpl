     ...
     <div class="modal-dialog ">
       <div class="modal-content">
         ...
         <div class="modal-footer">
           <button type="button" class="btn btn-danger" data-bs-dismiss="modal">{$stMENSAJE_BOTON_CANCELAR}</button>
         ...
         $.ajax({
           ...
           success: function(response) {
             ...
             if (response === "ok") {
               ...
               setTimeout(function() {
                 $('#iconoCarrito')
                   .removeClass('fa-solid fa-basket-shopping fa-shake')
         ...
         function comentarios_modal_pedidos(boton) {
           ...
           productos.forEach(producto => {
             ...
             for (var i = 0; i < cantidad; i++) {
               ...
               dFlexDiv.className = 'd-flex flex-column justify-content-around align-items-baseline';
