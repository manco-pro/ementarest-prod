              ...
              <div class="row">
                ...
                <div class="col m-0 p-0">
                  <div class="d-flex flex-column justify-content-around align-items-baseline">
                    <h2 class="fs-6 fw-bold mb-0">{$producto.nombre_es|default:$producto.nombre_pt}</h2>
            ...
            <div class="row">
              ...
              <div class="col-12">
                {*<div class="d-grid gap-2 mt-3">
                  <button class="btn btn-dark" type="button">Confirmar pedido</button>
                  <button class="btn btn-danger" type="button">Cancelar orden</button>
                </div>*}
              </div>
            </div>
          </div>-->
