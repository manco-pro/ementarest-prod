        ...
        {foreach from=$stCOLECCIONES key=id item=Coleccion}
          <div class="col-12 col-sm-6 col-lg-4">
            ...
            <div class="bg-light mb-4 px-2 py-2 shadow" style="margin-top: -18px; border-radius: 0 0 10px 10px;">
              <div class="row">
                <div class="col-12 text-start ps-3">{$Coleccion.nombre_es|default:$Coleccion.nombre_pt}</div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="alert alert-success alert-dismissible fade show mmalert d-none" role="alert">
                <strong>El Producto se ha insertado correctamente.</strong>
              ...
              <div class="mb-4 px-2 py-2" style="margin-top: -18px;">
                <div class="row">
                  <div class="col-6 text-start ps-3 fs-4 fw-bold mt-2">{$Coleccion.nombre_es|default:$Coleccion.nombre_pt}
                  </div>
                  ...
                  {if {$Coleccion.descripcion_pt}!=''}
                    <div class="col-12 text-start ps-2">
                      <p>
                        ...
                        {$Coleccion.descripcion_es|default:$Coleccion.descripcion_pt}
                      </p>
                    </div>
                  {/if}
                  <div class="col-12 h-100 " style="border-radius: 8px; border: 1px solid #dddddd;">
                    <div class="row">
                      <div class="col-9 text-start m-0 p-0">
                        <p class="px-3 pt-3">
                          <strong>&iexcl;Recomienda este plato a tus amigos!</strong>
                        </p>
                      </div>
                      <div class="col-3 text-start " id="compartir{$Coleccion.id}"
                        data-title="{$Coleccion.nombre_es|default:$Coleccion.nombre_pt}"
                        data-text="{$Coleccion.descripcion_es|default:"D&eacute;jate llevar por los sabores excepcionales de este plato."}"
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col fs-6 lh-sm mt-2">
                        <p class="m-0 p-0 fw-bold"><a
                            class="link-dark text-decorado-none">{$coleccion.nombre_es|default:$coleccion.nombre_pt}</a></p>
