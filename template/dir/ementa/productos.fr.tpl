        ...
        {foreach from=$stCOLECCIONES key=id item=Coleccion}
          <div class="col-12 col-sm-6 col-lg-4">
            ...
            <div class="bg-light mb-4 px-2 py-2 shadow" style="margin-top: -18px; border-radius: 0 0 10px 10px;">
              <div class="row">
                <div class="col-12 text-start ps-3">{$Coleccion.nombre_fr|default:$Coleccion.nombre_pt}</div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">D&eacute;tails</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <div class="alert alert-success alert-dismissible fade show mmalert d-none" role="alert">
                <strong>Le produit a &eacute;t&eacute; ins&eacute;r&eacute; avec succ&egrave;s.</strong>
              ...
              <div class="mb-4 px-2 py-2" style="margin-top: -18px;">
                <div class="row">
                  <div class="col-6 text-start ps-3 fs-4 fw-bold mt-2">{$Coleccion.nombre_fr|default:$Coleccion.nombre_pt}
                  </div>
                  ...
                  {if {$Coleccion.descripcion_pt}!=''}
                    <div class="col-12 text-start ps-2">
                      <p>
                        ...
                        {$Coleccion.descripcion_fr|default:$Coleccion.descripcion_pt}
                      </p>
                    </div>
                  {/if}
                  <div class="col-12 h-100 " style="border-radius: 8px; border: 1px solid #dddddd;">
                    <div class="row">
                      <div class="col-9 text-start m-0 p-0">
                        <p class="px-3 pt-3">
                          <strong>Recommandez ce plat &agrave; vos amis !</strong>
                        </p>
                      </div>
                      <div class="col-3 text-start " id="compartir{$Coleccion.id}"
                        data-title="{$Coleccion.nombre_fr|default:$Coleccion.nombre_pt}"
                        data-text="{htmlspecialchars($Coleccion.descripcion_fr|default:'Laissez-vous emporter par les saveurs exceptionnelles de ce plat.')}"
              ...
              {if $Coleccion.sugerencias_colecciones_ids != ''}
                <div class="bg-light rounded my-4 p-2 fw-bold text-dark">
                  Boisson sugg&eacute;r&eacute;e
                </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col fs-6 lh-sm mt-2">
                        <p class="m-0 p-0 fw-bold"><a
                            class="link-dark text-decorado-none">{$coleccion.nombre_fr|default:$coleccion.nombre_pt}</a></p>
