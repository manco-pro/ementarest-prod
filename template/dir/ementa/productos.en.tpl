        ...
        {foreach from=$stCOLECCIONES key=id item=Coleccion}
          <div class="col-12 col-sm-6 col-lg-4">
            ...
            <div class="bg-light mb-4 px-2 py-2 shadow" style="margin-top: -18px; border-radius: 0 0 10px 10px;">
              <div class="row">
                <div class="col-12 text-start ps-3">{$Coleccion.nombre_en|default:$Coleccion.nombre_pt}</div>
                <div class="col-12 text-start ps-3"><strong>{$Coleccion.precio} &euro;{if $Coleccion.unidad==2}/kg{/if}</strong></div>
              </div>
            </div>
          </div>
        {/foreach}
      ...
      <div class="modal fade" id="modal{$Coleccion.id}" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <strong>The Product has been inserted successfully.</strong>
            <button type="button" class="btn-close fechaemmodal"></button>
              ...
              <div class="mb-4 px-2 py-2" style="margin-top: -18px;">
                <div class="row">
                  <div class="col-6 text-start ps-3 fs-4 fw-bold mt-2">{$Coleccion.nombre_en|default:$Coleccion.nombre_pt}
                  </div>
                  ...
                  {if {$Coleccion.descripcion_pt}!=''}
                    <div class="col-12 text-start ps-2">
                      <p>
                        ...
                        {$Coleccion.descripcion_en|default:$Coleccion.descripcion_pt}
                      </p>
                    </div>
                  {/if}
                  <div class="col-12 h-100 " style="border-radius: 8px; border: 1px solid #dddddd;">
                    <div class="row">
                      <div class="col-9 text-start m-0 p-0">
                        <p class="px-3 pt-3">
                          <strong>Recommend this dish to your friends!</strong>
                        </p>
                      </div>
                      <div class="col-3 text-start " id="compartir{$Coleccion.id}"
                        data-title="{$Coleccion.nombre_en|default:$Coleccion.nombre_pt}"
                        data-text="{htmlspecialchars($Coleccion.descripcion_en|default:"Let yourself be carried away by the exceptional flavors of this dish.")}"
             ...
             <!-- PRODUTOS SUGERIDO -->
             {if $Coleccion.sugerencias_colecciones_ids != false}
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col fs-6 lh-sm mt-2">
                      <p class="m-0 p-0 fw-bold"><a
                          class="link-dark text-decorado-none">{$coleccion.nombre_en|default:$coleccion.nombre_pt}</a></p>
