      ...
      <div class="row">
              ...
              <div class="row">
                ...
                <div class="col m-0 p-0">
                  <div class="d-flex flex-column justify-content-around align-items-baseline">
                    <h2 class="fs-6 fw-bold mb-0">{$producto.nombre_en|default:$producto.nombre_pt}</h2>
        ...
        <div class="mt-3 mb-5">
          ...
          <div class="input-group">
            ...
            <button class="btn btn-secondary" type="button" id="button-addon2">To apply</button>
          </div>-->
            ...
            <div class="row">
              ...
              <div class="col-12">
                {*<div class="d-grid gap-2 mt-3">
                  <button class="btn btn-dark" type="button">Confirm Order</button>
